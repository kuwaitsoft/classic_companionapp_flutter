...
class OTPVerificationnScreen extends StatefulWidget {
  const OTPVerificationnScreen({super.key});

  @override
  State<OTPVerificationnScreen> createState() => _OTPVerificationnScreenState();
}

class _OTPVerificationnScreenState extends State<OTPVerificationnScreen> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              PVSolidButton(
                  title: (otpCorrect == false) ? submit : login,
                  onPressed: () {
                    if (otpCorrect == false) {
                      setState(() {
                        otpCorrect = true;
